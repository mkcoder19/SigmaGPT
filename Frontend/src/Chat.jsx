...
export default function Chat(){
    ...
    useEffect(()=>{
        ...
        //Effect to get the latest reply from the server
    ...
    // Ensure prevChats is always an array
                        ...
                        <>
                            {
                                latestReply === null ? (
                                    <div className="gptDiv" key={"non-typing"}>
                                        <ReactMarkdown rehypePlugins={[rehypeHighlight]}>{safePrevChats[safePrevChats.length - 1].content}</ReactMarkdown>
                                    </div>
                                ) : (
